        ...
        <>
            ...
            <div className="w-3/5 flex flex-col items-center
                ...
                <div className="w-full flex flex-col">
                    ...
                    <input value="15" onChange={(e)=>setDownPayment(e.target.value)}
                    ...
                    <input value="20" onChange={(e)=>setDownPayment(e.target.value)}
                    ...
                    <input value="25" onChange={(e)=>setDownPayment(e.target.value)}
                    ...
                    <input value="30" onChange={(e)=>setDownPayment(e.target.value)}
                    ...
                    <input value="35" onChange={(e)=>setDownPayment(e.target.value)}
                ...
                <button onClick={handleCalCarClick}
